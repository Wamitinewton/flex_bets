...
import 'package:betting_app/bet/Screens/bottom_navigation_screens/home_screens/place_bet_again_screen.dart';
import 'package:betting_app/bet/Screens/bottom_navigation_screens/home_screens/place_bet_screen.dart';
...
import 'package:betting_app/bet/src/Screens/bottom_navigation_screens/home_screens/comments_screen.dart';
...
class BetSearchCard extends StatefulWidget {
  const BetSearchCard(
      {super.key,
      required this.data,
      required this.user,
  ...
  @override
  State<BetSearchCard> createState() => _BetSearchCardState();
}

class _BetSearchCardState extends State<BetSearchCard> {
  String selected = '';
  int index = 3;
  bool liked = false;
  bool shared = false;
  ...
  getBets() {
    try {
      ...
      snapshots.forEach((element) {
        ...
        setState(() {});
        print('got bets placed by users');
      });
    } catch (e) {
